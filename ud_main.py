...
if __name__ == '__main__':
    ...
    shutil.rmtree("/home/alex/git/IATI-annual-report-2019/sep/")
    os.mkdir("/home/alex/git/IATI-annual-report-2019/sep/")

    # Where to look for saved IATI XML via registry-refresher
    rootdir = '/home/alex/git/IATI-annual-report-2019/data'

    # Predefined header names
    header = iatiflat.header
    full_header = header + ["publisher"]
    header_frame = pd.DataFrame([full_header])
    header_frame.to_csv("/home/alex/git/IATI-annual-report-2019/sep/000header.csv", index=False, header=False, encoding="utf-8")
    ...
    for subdir, dirs, files in os.walk(rootdir):
        for filename in files:
            ...
            if len(output) > 0:
                ...
                data.to_csv("/home/alex/git/IATI-annual-report-2019/sep/{}.csv".format(filename), index=False, header=False, encoding="utf-8")
    ...
    os.system("cat /home/alex/git/IATI-annual-report-2019/sep/*.csv > /home/alex/git/IATI-annual-report-2019/output/iati_unfiltered_disagg.csv")
